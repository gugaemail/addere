...
const variantClasses: Record<Variant, string> = {
  ...
  outline:   'border border-[var(--border)] text-[var(--text-secondary)] bg-transparent hover:bg-[var(--bg-subtle)] disabled:opacity-40',
  ghost:     'text-brand bg-transparent hover:bg-brand/10 disabled:opacity-50',
  danger:    'bg-danger text-white hover:opacity-90 disabled:opacity-50',
  'danger-outline':  'border border-danger/30 text-danger bg-transparent hover:bg-danger/10 disabled:opacity-50',
  'success-outline': 'border border-success/30 text-success bg-transparent hover:bg-success/10 disabled:opacity-50',
}
