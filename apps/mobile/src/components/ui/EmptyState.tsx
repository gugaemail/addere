...
function ClientsIllustration() {
  return (
    <Svg width={120} height={120} viewBox="0 0 120 120">
      ...
      <Circle cx="52" cy="52" r="38" stroke={colors.brand.primary} strokeWidth="2.5" fill="none" />
      {/* Head */}
      <Circle cx="52" cy="42" r="11" fill={colors.brand.primary} />
      {/* Shoulders */}
      <Path d="M28 72 Q28 58 52 58 Q76 58 76 72" fill={colors.brand.primary} />
      {/* Search circle badge */}
      <Circle
        cx="83"
        cy="83"
        ...
        strokeWidth="2.5"
      />
      <Circle cx="80" cy="80" r="7" stroke={colors.brand.primary} strokeWidth="2.5" fill="none" />
      <Line
        x1="85"
        y1="85"
        x2="93"
...
function GoalsIllustration() {
  return (
    <Svg width={120} height={120} viewBox="0 0 120 120">
      ...
      />
      {/* Bar 2 — medium */}
      <Rect x="56" y="54" width="16" height="36" rx="3" fill={colors.brand.primary} opacity={0.6} />
      {/* Bar 3 — tall, accent */}
      <Rect x="80" y="34" width="16" height="56" rx="3" fill={colors.brand.accent} />
      {/* Trend arrow */}
      <Path
...
export function EmptyState({
  ...
  return (
    <View style={styles.container} testID={testID}>
      ...
      {actionLabel && (
        <Button variant="secondary" size="md" onPress={onAction} style={styles.action}>
          {actionLabel}
        </Button>
      )}
    </View>
