...
| --- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ | -------------------------------------------- |
| 1   | ~~Contrato da API "qualquer SELECT"~~ ✅ **GO** (P1–P9 + payload real no §2.7; campo `query` e resposta confirmados, adapter alinhado em 19ca15e). Pendências: URL de homologação + nomes dos params de paginação no request | E4 (validar no backfill real) | Gustavo + consultor Protheus                 |
